...
namespace System
{
    public static class PersianDateExtensionMethods
    {
        ...
        public static string ToPersianDateTimeString(this DateTime date, string format = "yyyy/MM/dd  ( HH:mm:ss )")
        {
            TimeZoneInfo iranTimeZone = TimeZoneInfo.FindSystemTimeZoneById("Iran Standard Time");
            DateTime iranDateTime = TimeZoneInfo.ConvertTimeFromUtc(date, iranTimeZone);
            return iranDateTime.ToString(format, GetPersianCulture());
        }
    }
}